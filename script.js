...
document.addEventListener("readystatechange", function () {
    if (document.readyState === "complete") {
        ...
        document.querySelector(".loader img").style.scale = "0.5";
        document.querySelector(".loader img").style.transform= "translateY(100%) rotateZ(360deg)";
...
function overlay() {
    document.querySelectorAll(".same").forEach(function (elem) {
        var clutter = "";
...
function hammenu(){
    ...
    if(flag===0){
        ...
        gsap.to("#hamburger .ham",{
            backgroundColor:"#000"
        })
        gsap.to("#hamburger #line1",{
            rotate:"-45deg"
        })
        gsap.to("#hamburger #line2",{
            rotate:"45deg"
        })
        gsap.to("#hampage",{
            top:"0%"
...
function second(){
    document.querySelectorAll(".splitletter").forEach(function(elem){
        var clutter = "";
    ...
    gsap.from("#thirdpage .splitletter span",{
        opacity:0,
        scrollTrigger:{
            trigger:"#thirdpage",
            start:"top 80%",
    ...
    gsap.from("#fourthpage .splitletter span",{
        opacity:0,
        scrollTrigger:{
            trigger:"#texti",
            start:"top 80%",
...
document.querySelector("#hamburger").addEventListener("mouseenter",function(){
    ...
    document.querySelector("#cursor").style.backgroundColor="pink"
})
